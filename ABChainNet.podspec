#
#  Be sure to run `pod spec lint ABChainNet.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/caobo56/ABChainNet"
  ...
  s.source       = { :git => "https://github.com/caobo56/ABChainNet.git", :tag => "0.9.9" }
  ...
  s.subspec "MRC" do |mrc|
    mrc.source_files = 'ABChainNet/ChainNet/MRC/*.{h,m}'
    mrc.dependency 'Protobuf'
